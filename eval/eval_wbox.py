...
def main():
    ...
    if args.subset_num:
        ...
        testloader = utils.get_testloader(args, batch_size=100, shuffle=False, subset_idx=subset_idx)
    else:
        testloader = utils.get_testloader(args, batch_size=100, shuffle=False)
