...
def model_args(parser):
    ...
    group.add_argument('--arch', default='WRN', type=str, choices=['ResNet','WRN'], 
    ...
    group.add_argument('--gpu', default='7', type=str, 
                       help='gpu id')
    group.add_argument('--seed', default=0, type=int,
                       help='random seed for torch')
    group.add_argument('--fb', default=0.8, type=float, 
                       help='learning rate')
...
def data_args(parser):
    ...
    group.add_argument('--dateset', type=str, default='cifar10',
                       help='Dataset directory')
...
def base_train_args(parser):
    ...
    group.add_argument('--lr', default=0.01, type=float, 
                       help='learning rate')
...
def dverge_train_args(parser):
    ...
    group.add_argument('--distill-fixed-layer', default=True, action="store_true",
...
def adv_train_args(parser):
    ...
    group.add_argument('--eps', default=0.02, type=float, 
                       help='perturbation budget for adversarial training')
    group.add_argument('--alpha', default=2./255., type=float, 
                       help='step size for adversarial training')
    group.add_argument('--steps', default=10, type=int, 
